...
/**** like/ dislike des sauces 
 ...
 4: include : permet de determiner si un tableau contient 1 valeur : renvoi true si oui
 5 : rajouter l'ID du user (usersLiked) si elle n'existe pas deja : addToSet
 6: * incrémenter le like de 1  : $inc
...
exports.voteSauce = (req, res, next) => {
  ...
  if (req.body.like === 1) {
    ...
    Sauce.findByIdAndUpdate(
      ...
      { _id: req.params.id },{ $inc: { likes: 1 }, $addToSet: { usersLiked: req.body.userId } })
      .then(() =>
